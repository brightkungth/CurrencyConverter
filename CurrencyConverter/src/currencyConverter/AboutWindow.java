...
public class AboutWindow extends JFrame {
	...
	private AboutWindow() {
		...
		JLabel lblLink = new JLabel("Open Folder");
		...
		// label "name2"
		JLabel lblLicenceMit = new JLabel("Chanin Wimonmongkhonphon 1620901304");
		...
		// label "name1"
		JLabel lblVersion = new JLabel("Made By Jirapat Pimkaew 1620901601");
